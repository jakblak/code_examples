var module = angular.module('demoApp', ['ngMockE2E','ngRoute','mgcrea.ngStrap']).config(['$provide', '$routeProvider', '$locationProvider', function($provide, $routeProvider, $locationProvider) {
